...
import { GeminiAPI } from './src/ai/gemini-api';
...
async function generateUIFromAPI(prompt, systemPrompt, enableValidation = true) {
    try {
        ...
        if (enableValidation && validationEngine) {
            ...
            const validationData = await validationEngine.validateWithRetry(response.content, prompt, geminiAPI);
...
async function createGeminiClientFromStorage() {
    try {
        const apiKey = await figma.clientStorage.getAsync('geminiApiKey');
        if (apiKey) {
    ...
    figma.on('run', async (event) => {
        ...
        switch (command) {
            case 'scan':
                ...
                break;
            case 'debug':
                await handleDebugCommand(parameters === null || parameters === void 0 ? void 0 : parameters.componentId);
                break;
            case 'test-migration':
        ...
        switch (msg.type) {
            ...
            case 'get-all-sessions':
                try {
                    ...
                    const formattedSessions = allSessions.map(session => SessionService.formatSessionForUI(session));
                    figma.ui.postMessage({
            ...
            case 'generate-llm-prompt':
                try {
                    ...
                    if (scanSession && ((_a = scanSession.components) === null || _a === void 0 ? void 0 : _a.length)) {
                        const llmPrompt = DesignSystemScannerService.generateLLMPrompt(scanSession.components, scanSession.colorStyles);
            ...
            case 'run-ai-pipeline':
                try {
                    ...
                    if (result.success) {
                        ...
                        if ((_b = result.finalResult) === null || _b === void 0 ? void 0 : _b.generatedJSON) {
                            ...
                            figma.ui.postMessage({
                                ...
                                result: {
                                    ...
                                    frameId: newFrame === null || newFrame === void 0 ? void 0 : newFrame.id,
                            ...
                            figma.ui.postMessage({
                                ...
                                result: {
                                    pipelineStats: result.aiUsageStats,
                                    content: (_c = result.finalResult) === null || _c === void 0 ? void 0 : _c.content,
                                    executionTime: result.executionTime,
                                    stagesCompleted: result.stages.length
                                }
                            });
            ...
            case 'render-json-direct':
                try {
                    ...
                    if (json.layoutContainer && json.layoutContainer.items) {
                        ...
                        renderData = Object.assign(Object.assign({}, json.layoutContainer), { items: json.layoutContainer.items });
                    }
                    console.log('🔧 Transformed JSON for rendering:', renderData);
                    console.log('🔧 JSON has items?', !!renderData.items, 'Count:', (_d = renderData.items) === null || _d === void 0 ? void 0 : _d.length);
                    ...
                    console.log('🔧 Generated frame:', newFrame, 'ID:', newFrame === null || newFrame === void 0 ? void 0 : newFrame.id);
                    if (newFrame) {
                        figma.ui.postMessage({
