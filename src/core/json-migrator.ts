...
export class JSONMigrator {
  ...
  static migrateToSystematic(originalJSON: any): any {
  ...
  static generateMigrationPreview(originalJSON: any): any {
  ...
  static traverseAndMerge(items: any[]): any[] {
    if (!items) {
      return [];
    }
  ...
  static mergeConsecutiveTabs(items: any[]): any[] {
